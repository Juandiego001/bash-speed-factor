...
SET /p NUMERO=Digite el numero que desea probar: 
SET NUMERO=%NUMERO%
...
SET /A MICRO_TOTAL_TIME=(%MICRO_SEGUNDOS_TIEMPO_FINAL% - %MICRO_SEGUNDOS_TIEMPO_INICIO%)*(%MICRO_SEGUNDOS_TIEMPO_FINAL% - %MICRO_SEGUNDOS_TIEMPO_INICIO%)
...
IF %MICRO_TOTAL_TIME% NEQ 0 SET /A MICRO_TOTAL_TIME=%MICRO_TOTAL_TIME%/(%MICRO_SEGUNDOS_TIEMPO_FINAL% - %MICRO_SEGUNDOS_TIEMPO_INICIO%)
IF %MICRO_TOTAL_TIME% NEQ 0 ECHO SE DEMORO MAS DE 0 MICRO SEGUNDOS
